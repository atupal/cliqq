...
class top():
    ...
    def line_dialog(self, uid, Text = None):
        text = urwid.Text(uid, align = 'center')
        for i in Text:
    ...
    def open_dialog(self, button):
        ...
        self.main.original_widget = urwid.Columns([urwid.Padding(urwid.ListBox(urwid.SimpleFocusListWalker(self.body)), left = 2, right = 2), text])
        self.flag = 1
